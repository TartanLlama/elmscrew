...
var _TartanLlama$elmscrew$Elmscrew_Instruction$toChar = function (inst) {
	var _p0 = inst;
	switch (_p0.ctor) {
		case 'Right':
...
var _TartanLlama$elmscrew$Elmscrew_Instruction$Jump = function (a) {
	return {ctor: 'Jump', _0: a};
};
var _TartanLlama$elmscrew$Elmscrew_Instruction$JumpMarker = {ctor: 'JumpMarker'};
var _TartanLlama$elmscrew$Elmscrew_Instruction$Input = {ctor: 'Input'};
var _TartanLlama$elmscrew$Elmscrew_Instruction$Output = {ctor: 'Output'};
var _TartanLlama$elmscrew$Elmscrew_Instruction$Dec = {ctor: 'Dec'};
var _TartanLlama$elmscrew$Elmscrew_Instruction$Inc = {ctor: 'Inc'};
var _TartanLlama$elmscrew$Elmscrew_Instruction$Left = {ctor: 'Left'};
var _TartanLlama$elmscrew$Elmscrew_Instruction$Right = {ctor: 'Right'};
var _TartanLlama$elmscrew$Elmscrew_Instruction$toInst = F3(
	function (charIdx, stack, c) {
		var _p1 = c;
		switch (_p1.valueOf()) {
			case '>':
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Maybe$Just(_TartanLlama$elmscrew$Elmscrew_Instruction$Right),
					_1: stack,
					_2: charIdx + 1
				};
			case '<':
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Maybe$Just(_TartanLlama$elmscrew$Elmscrew_Instruction$Left),
					_1: stack,
					_2: charIdx + 1
				};
			case '+':
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Maybe$Just(_TartanLlama$elmscrew$Elmscrew_Instruction$Inc),
					_1: stack,
					_2: charIdx + 1
				};
			case '-':
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Maybe$Just(_TartanLlama$elmscrew$Elmscrew_Instruction$Dec),
					_1: stack,
					_2: charIdx + 1
				};
			case '.':
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Maybe$Just(_TartanLlama$elmscrew$Elmscrew_Instruction$Output),
					_1: stack,
					_2: charIdx + 1
				};
			case ',':
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Maybe$Just(_TartanLlama$elmscrew$Elmscrew_Instruction$Input),
					_1: stack,
					_2: charIdx + 1
				};
			case '[':
				return {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Maybe$Just(_TartanLlama$elmscrew$Elmscrew_Instruction$JumpMarker),
					_1: {ctor: '::', _0: charIdx, _1: stack},
					_2: charIdx + 1
				};
			case ']':
				return {
					...
					_0: _elm_lang$core$Maybe$Just(
						_TartanLlama$elmscrew$Elmscrew_Instruction$Jump(
							A2(
								_TartanLlama$elmscrew$Elmscrew_Utils$unwrap,
								'Unmatched brackets',
								_elm_lang$core$List$head(stack)))),
					_1: A2(_elm_lang$core$List$drop, 1, stack),
					_2: charIdx + 1
				};
			default:
				return {ctor: '_Tuple3', _0: _elm_lang$core$Maybe$Nothing, _1: stack, _2: charIdx};
		}
	});
...
var _TartanLlama$elmscrew$Elmscrew_Parser$buildProg = F3(
	function (charIdx, stack, chars) {
		var _p0 = chars;
		if (_p0.ctor === '::') {
			var _p1 = A3(_TartanLlama$elmscrew$Elmscrew_Instruction$toInst, charIdx, stack, _p0._0);
			var inst = _p1._0;
			var newStack = _p1._1;
			var newCharIdx = _p1._2;
			return {
				ctor: '::',
				_0: inst,
				_1: A3(_TartanLlama$elmscrew$Elmscrew_Parser$buildProg, newCharIdx, newStack, _p0._1)
			};
		} else {
			return {ctor: '[]'};
		}
	});
var _TartanLlama$elmscrew$Elmscrew_Parser$isJust = function (a) {
	var _p2 = a;
	if (_p2.ctor === 'Just') {
		return true;
	} else {
...
var _TartanLlama$elmscrew$Elmscrew_Parser$parse = function (str) {
	return _elm_lang$core$Array$fromList(
		A2(
			_elm_lang$core$List$map,
			_elm_lang$core$Maybe$withDefault(_TartanLlama$elmscrew$Elmscrew_Instruction$Input),
			A2(
				_elm_lang$core$List$filter,
				_TartanLlama$elmscrew$Elmscrew_Parser$isJust,
				A3(
					_TartanLlama$elmscrew$Elmscrew_Parser$buildProg,
					0,
					{ctor: '[]'},
...
var _TartanLlama$elmscrew$Elmscrew_Machine$get = function (machine) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		A2(_elm_lang$core$Dict$get, machine.position, machine.tape));
};
var _TartanLlama$elmscrew$Elmscrew_Machine$Machine = F2(
	function (a, b) {
		return {tape: a, position: b};
	});
var _TartanLlama$elmscrew$Elmscrew_Machine$init = A2(_TartanLlama$elmscrew$Elmscrew_Machine$Machine, _elm_lang$core$Dict$empty, 0);
var _TartanLlama$elmscrew$Elmscrew_Machine$set = F2(
	function (machine, i) {
		return A2(
			_TartanLlama$elmscrew$Elmscrew_Machine$Machine,
			A3(_elm_lang$core$Dict$insert, machine.position, i, machine.tape),
			machine.position);
	});
var _TartanLlama$elmscrew$Elmscrew_Machine$incr = function (machine) {
	return A2(
		_TartanLlama$elmscrew$Elmscrew_Machine$set,
		machine,
		1 + _TartanLlama$elmscrew$Elmscrew_Machine$get(machine));
};
var _TartanLlama$elmscrew$Elmscrew_Machine$decr = function (machine) {
	return A2(
		_TartanLlama$elmscrew$Elmscrew_Machine$set,
		machine,
		-1 + _TartanLlama$elmscrew$Elmscrew_Machine$get(machine));
};
var _TartanLlama$elmscrew$Elmscrew_Machine$right = function (machine) {
	return A2(_TartanLlama$elmscrew$Elmscrew_Machine$Machine, machine.tape, machine.position + 1);
};
var _TartanLlama$elmscrew$Elmscrew_Machine$left = function (machine) {
	return A2(_TartanLlama$elmscrew$Elmscrew_Machine$Machine, machine.tape, machine.position - 1);
};
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						interp,
						{
							pc: (_elm_lang$core$Native_Utils.cmp(
								_TartanLlama$elmscrew$Elmscrew_Machine$get(interp.machine),
...
var _TartanLlama$elmscrew$Elmscrew_Interpreter$Interpreter = F4(
	function (a, b, c, d) {
		return {instructions: a, machine: b, pc: c, output: d};
	});
var _TartanLlama$elmscrew$Elmscrew_Interpreter$initWithProg = function (prog) {
	return A4(_TartanLlama$elmscrew$Elmscrew_Interpreter$Interpreter, prog, _TartanLlama$elmscrew$Elmscrew_Machine$init, 0, _elm_lang$core$Maybe$Nothing);
};
var _TartanLlama$elmscrew$Elmscrew_Interpreter$initWithStr = function (str) {
	return _TartanLlama$elmscrew$Elmscrew_Interpreter$initWithProg(
		_TartanLlama$elmscrew$Elmscrew_Parser$parse(str));
};
...
var _TartanLlama$elmscrew$Elmscrew_Vis$displayGraph = _elm_lang$core$Native_Platform.outgoingPort(
	'displayGraph',
	function (v) {
		return [v._0, v._1];
	});
var _TartanLlama$elmscrew$Elmscrew_Vis$sendCurrentNode = _elm_lang$core$Native_Platform.outgoingPort(
	'sendCurrentNode',
	function (v) {
		return v;
	});
	...
	var getData = F2(
		function (tape, n) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				0,
				A2(_elm_lang$core$Dict$get, n, tape));
		});
				...
				_0: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'id',
							_1: _elm_lang$core$Json_Encode$int(n)
						},
						_1: {
							ctor: '::',
							_0: {
...
var _TartanLlama$elmscrew$Main$setCurrentNode = function (interp) {
	...
	return _TartanLlama$elmscrew$Elmscrew_Vis$sendCurrentNode(id);
};
...
var _TartanLlama$elmscrew$Main$update = F2(
	function (msg, model) {
		...
		var handleStep = function (result) {
			var _p7 = result;
			if (_p7.ctor === 'Running') {
				return A3(handleNewExecution, _p7._0, _p7._1, _p7._2);
			} else {
				var _p8 = _p7._0;
				return {
					ctor: '_Tuple2',
					...
					_1: _TartanLlama$elmscrew$Main$setCurrentNode(_p8)
				};
			}
		};
		var executeInstruction = function (inst) {
			var _p9 = A3(_TartanLlama$elmscrew$Elmscrew_Interpreter$execute, maybeInitInterpreter, inst, model.input);
			var newInterp = _p9._0;
			var newInput = _p9._1;
			var newOutput = _p9._2;
		...
		switch (_p10.ctor) {
			case 'NewProgram':
				...
				var parsedProg = _elm_lang$core$Array$toList(
					_TartanLlama$elmscrew$Elmscrew_Parser$parse(_p11));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{program: _p11}),
					_1: _TartanLlama$elmscrew$Elmscrew_Vis$displayGraph(
						{
							ctor: '_Tuple2',
							_0: _elm_lang$core$Json_Encode$list(
								A2(_TartanLlama$elmscrew$Main$generateProgramGraphNodes, parsedProg, 0)),
			...
			case 'Left':
				return executeInstruction(_TartanLlama$elmscrew$Elmscrew_Instruction$Left);
			case 'Inc':
				return executeInstruction(_TartanLlama$elmscrew$Elmscrew_Instruction$Inc);
			case 'Dec':
				return executeInstruction(_TartanLlama$elmscrew$Elmscrew_Instruction$Dec);
			case 'Output':
				return executeInstruction(_TartanLlama$elmscrew$Elmscrew_Instruction$Output);
			default:
...
var _TartanLlama$elmscrew$Main$Inc = {ctor: 'Inc'};
var _TartanLlama$elmscrew$Main$Left = {ctor: 'Left'};
var _TartanLlama$elmscrew$Main$Right = {ctor: 'Right'};
var _TartanLlama$elmscrew$Main$makeInterpreterButtons = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	A2(
		_elm_lang$core$List$map,
		...
		},
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _TartanLlama$elmscrew$Main$Dec, _1: '-'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: _TartanLlama$elmscrew$Main$Output, _1: '.'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: _TartanLlama$elmscrew$Main$Input, _1: ','},
								_1: {ctor: '[]'}
							}
						}
					}
...
var _TartanLlama$elmscrew$Main$main = _elm_lang$html$Html$program(
	{init: _TartanLlama$elmscrew$Main$init, view: _TartanLlama$elmscrew$Main$view, update: _TartanLlama$elmscrew$Main$update, subscriptions: _TartanLlama$elmscrew$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _TartanLlama$elmscrew$Main$main !== 'undefined') {
    _TartanLlama$elmscrew$Main$main(Elm['Main'], 'Main', undefined);
}
